//
// Created by filippo on 25/07/21.
//

#ifndef QCGAUGEWIDGET_ROUNDGAUGEGRAPHICSOBJECT_H
#define QCGAUGEWIDGET_ROUNDGAUGEGRAPHICSOBJECT_H
...
#endif //QCGAUGEWIDGET_ROUNDGAUGEGRAPHICSOBJECT_H
