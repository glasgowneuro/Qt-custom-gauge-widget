    ...
    ui(new Ui::MainWindow)
{
    ...
    mScene->setBackgroundBrush(QBrush("white"));
    ...
    mRoundGauge->setOuterRingColor(QColor("black"));
    mRoundGauge->setGlowRingColor(QColor("yellow"));



    mRoundGauge->setValueColor(QColor("blue"));
    mRoundGauge->setFontColor(QColor("white"));
